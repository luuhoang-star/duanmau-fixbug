...
<div class="row2">
    <div class="font_title">
        <h1><i class="fa-solid fa-pen-to-square"></i> CẬP NHẬT DANH MỤC</h1>
    ...
    <div class="form_content" style="max-width: 650px;">
        <form action="index.php?act=updatedm" method="POST">
            <div class="form_content_container">
                ...
                <input type="text" name="maloai" value="<?=$id ?? ''?>" disabled style="background: #f1f5f9; color: #94a3b8;">
            </div>

            <div class="form_content_container">
                <label><i class="fa-solid fa-layer-group"></i> Tên loại danh mục</label>
                <input type="text" name="tenloai" value="<?=$name ?? ''?>" required placeholder="Nhập tên loại danh mục...">
            </div>

            <div style="display: flex; gap: 12px; margin-top: 20px; border-top: 1px solid #e2e8f0; padding-top: 20px;">
                <input type="hidden" name="id" value="<?=$id ?? ''?>">
                <input type="submit" name="capnhat" value="CẬP NHẬT DANH MỤC" style="padding: 11px 24px;">
