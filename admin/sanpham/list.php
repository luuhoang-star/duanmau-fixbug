          ...
          <form action="#" method="POST">
           ...
           <table>
            <tr>
                ...
                <a href="' . $hard_delete .'"><input type = "button" value="Xoá cứng" onclick="return confirm(\'Bạn có chắc chắn muốn xóa\')"></a>
                <a href="' . $soft_delete .'"><input type = "button" value="Xoá mềm" onclick="return confirm(\'Bạn có chắc chắn muốn xóa\')"></a>
                </td>
            </tr>';
                }
                ?>
